...
export default function StemThemes() {
  ...
  const themes: Theme[] = [
    ...
    },
    {
      ...
      level: "Lise",
      levelColor: "emerald",
      theme: "Yenilenebilir Enerji",
      topic: "Güneş Enerjisi ile Elektrik Üretimi",
      image: "/images/themes/yenilenebilir-enerji.jpg",
      pdfUrl: "/docs/yenilenebilir-enerji.pdf",
    },
    {
      id: "mekanik-sistemler",
      level: "İlkokul",
      levelColor: "orange",
      theme: "Mekanik Sistemler",
      topic: "Basit Makineler ve Kaldıraçlar",
      image: "/images/themes/mekanik-sistemler.jpg",
      pdfUrl: "/docs/mekanik-sistemler.pdf",
    },
    {
